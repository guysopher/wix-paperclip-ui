...
function buildActivationIssueDescription(args: {
  ...
  lines.push('- End with a CTA-style question like "May I hire this team so we can get started, or would you like any changes?"');
  ...
  lines.push('- Ask a direct closing question like "May I hire this team so we can get started, or would you like any changes?"');
  lines.push("");
  ...
  lines.push('- Ask whether you may hire the recommended team so you can get started, or whether they want any changes.');
