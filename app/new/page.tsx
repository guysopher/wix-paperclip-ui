...
function buildActivationIssueDescription(args: {
  ...
  lines.push('- End with a direct approval-or-change question like "Do you want me to hire this team or make changes?"');
  ...
  lines.push('- Ask a direct closing question like "Do you want me to hire this team or make changes?"');
  lines.push("");
  ...
  lines.push('- Ask whether they want you to hire the recommended team or make changes.');
