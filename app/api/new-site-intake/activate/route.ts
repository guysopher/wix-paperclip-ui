...
function buildSiteExecutionTask(summary: IntakeSummary): KickoffTask {
  const lines = [
    ...
    "4. If the completed creation job returns a site id, metasite id, or URL, write that verified data directly into wixBinding immediately.",
    "5. Use ListWixSites only as a fallback when the completed creation job does not expose the created site identity directly.",
    "6. Do not treat a started build job as success if wixBinding still lacks those verified fields.",
    "7. The main business site becomes the canonical company site in wixBinding.",
    "8. Do not expand the specialist team for ongoing site execution until the main site is bound into wixBinding.",
    "9. After the main site is bound, hire the Wix Site Expert and hand off normal site-building, content, and polish work.",
    "10. After the main site is bound, create the optional Picasso experimental site separately and record it as vibeSiteId, vibeSiteUrl, vibeSiteJobId, vibeSiteStatus, and vibeSiteDevelopmentUrl.",
