 ...
 *
 * Usage: npx tsx scripts/add-run-summary-to-agents.ts <companyId>
 */
...
async function updateAgents(companyId: string) {
...
if (!companyId) {
  console.error("Usage: npx tsx scripts/add-run-summary-to-agents.ts <companyId>");
  process.exit(1);
}
