...
const SITE_EXPERT_WIX_MCP_PROTOCOL = [
  ...
  "That board publish task must also include the exact metaSiteId and siteId, the current publish state, and the exact next action the board should take (for example: open this editor link, click Publish, choose the free domain flow, then report the resulting public URL).",
...
const SITE_EXPERT_PICASSO_PROTOCOL = [
  ...
  "That board publish task must also include the exact vibe site id and job id or project id, the current publish state, and the exact next action the board should take (for example: open this link, click Publish, choose Use a free Wix domain, then report the resulting public URL).",
