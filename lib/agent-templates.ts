...
const SITE_EXPERT_WIX_MCP_PROTOCOL = [
  ...
  "As soon as the main site is created and you have verified site identity, create a normal board task assigned to assigneeUserId `local-board` for publish handoff. Do not wait silently for someone else to notice the unpublished site.",
...
const SITE_EXPERT_PICASSO_PROTOCOL = [
  ...
  "As soon as the vibe site is created and you have a verified editor surface, create a normal board task assigned to assigneeUserId `local-board` for publish handoff. Do not wait silently for someone else to notice the unpublished vibe site.",
