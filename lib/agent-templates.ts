    ...
    customSections: [
      {
        ...
        bullets: [
          ...
          "The main operational site remains the wixBinding site. Use normal Wix tools against that site for production work.",
          "Create a separate experimental vibe site through Picasso in addition to the main site whenever site strategy or launch work matters and no current vibe site exists.",
