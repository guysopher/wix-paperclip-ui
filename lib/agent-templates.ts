...
const AGENT_BLUEPRINTS: AgentBlueprint[] = [
  {
    ...
    icon: "globe",
    summary:
      "Owns site strategy and execution. Builds and manages the main Wix site, and may create a separate Picasso vibe site as an experiment.",
    ...
    customSections: [
      {
        ...
        bullets: [
          ...
          "The main operational site always remains the wixBinding site. Use the standard Wix/Harmony tool path against that site for production work.",
          "In NEW SITE mode with no existing wixBinding.metaSiteId/siteId/siteUrl, treat creation of the main business site through the standard Wix/Harmony path as already approved team work.",
          ...
          "If the standard Wix/Harmony path is unavailable in the current runtime, log and report the tooling blocker clearly, but keep that blocker team-owned rather than asking the board to reconfirm site creation.",
          ...
          'If no vibe-site bridge job exists and an experimental site is required, call the bridge with POST /jobs using mode "create_site", the approved brief, designer "none", and identifying company context.',
