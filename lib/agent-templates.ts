...
const AGENT_BLUEPRINTS: AgentBlueprint[] = [
  {
    ...
    ownsEveryCheckIn: [
      ...
      "If the company has neither a main wixBinding site nor a vibe site yet, your first run must be a site-creation run, not a planning-only run.",
    ],
    collaboration: [
    ...
    customSections: [
      {
        ...
        bullets: [
          ...
          "If neither site exists yet, your first run must attempt to create the main Harmony site and the Picasso vibe site in the same run before doing architecture-only work.",
          ...
          'If no vibe-site bridge job exists and no vibe site exists yet, call the bridge with POST /jobs using mode "create_site", the approved brief, designer "none", and identifying company context.',
          ...
          "Do not mark the first site-build task done until at least one real site has been created and any missing second site is either created too or explicitly blocked by a concrete tooling failure.",
